...
import {Dimensions, PixelRatio, Platform, StyleSheet, View, Text, TouchableOpacity} from 'react-native';
    ...
    onMessage = (event) => {
        try {
            ...
            if(message.date!==undefined){
                this.setState({
                    richcontent:message.date
                })
                console.log(this.state.richcontent)
            }
