...
export default class RichToolbar extends Component {
    ...
    static defaultProps = {
        ...
        fontColorArr: ['black', 'red', 'yellow', 'pink', 'skyblue','#666666'],
    ...
    _onPressAddImage() {
        ...
        //     //     //console.log(src)
        //     // })
        //     var src=that.props.onPressAddImage();
        //     console.log('src'+'='+that.props.onPressAddImage());
        //     that.state.editor.insertImage(that.props.onPressAddImage());
        ...
        if (that.props.onPressAddImage) {
            that.props.onPressAddImage().then((res) => {
                ...
                // let src = res[0].base64;
                // console.log('1111111111111111111111111111111111'+src)
                that.state.editor.insertImage(res);
            })
        }
    }
