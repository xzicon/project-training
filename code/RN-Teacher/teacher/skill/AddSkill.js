...
import { Text, View ,Dimensions,StyleSheet, ScrollView, TextInput, Image, TouchableOpacity, ToastAndroid} from 'react-native'
...
export default class AddSkill extends Component {
    constructor(props) {
        ...
        this.state = {
            tid: this.props.tid,
            skilllevel:skilllevel[0].skilllevel,
            skilltrue:skilltrue[0].skilltrue=='是'?1:0,
            skilltype:skilltype[0].skilltype,
            skilltitle:'',
            skillimage:''
        }
    }
    ...
    nextstep=()=>{
        if(this.state.skilltitle==''){
            ...
            Actions.skillcontent({tid:this.state.tid,skilllevel:this.state.skilllevel,skilltrue:this.state.skilltrue,skilltype:this.state.skilltype,skilltitle:this.state.skilltitle,skillimage:this.state.skillimage})
        }
    }
    takephoto = (e) => {
