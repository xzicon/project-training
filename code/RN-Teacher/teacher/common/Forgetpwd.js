    ...
    sendCode = ()=>{
        if(this.state.temail===''){
            ...
            if(!data.temail.match(reg)){
                ...
                fetch('http://116.62.14.0:8402/teacher/forgetpwd',{
                    method:'POST',
                    headers:{
                ...
                .then(data=>{
                    ...
                    switch(data.status){
                        ...
                        case "-2":{
                            ...
                            ToastAndroid.show("该邮箱还没有注册哦",100);
                            break;
                        }
                        default:{
                            break;
            ...
            .then(res=>res.json()).then(data=>{
                ...
                switch (data.status) {
                    case "0":{
                        ...
                        Actions.Modifypwd({temail:this.state.temail});
                        break;
                    }
                    case "1":{
                        this.setState({
                    ...
                    <View style={styles.form_register}>
                        <View style={styles.form}>
                            ...
                            <View style={styles.tips}>
                                <Text onPress={()=>Actions.register()}>还没有账号？去注册</Text>
                            </View>
                            {
