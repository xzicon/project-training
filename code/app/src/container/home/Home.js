                ...
                top: 0 
                    ...
                    >
                            ...
                            <div>
                                <div style={{float:'left'}}>
                                    <div style={{position: 'fixed',top: '0',zIndex:'100000',width:'100%',backgroundColor:'#f5f5f9',paddingTop:'2%',paddingBottom:'2%',}}>
                                        <Link to={{pathname:'/'+arr[1]+'/home/search',state:this.props.location.state}}><SearchBar style={{width:'100%',backgroundColor:'#f5f5f9',float:'left'}} placeholder="输入关键字搜索作文"/></Link>
                                    </div>
                                    <div style={{zIndex:'100',top: '8%',position:'absolute',width:'100%',backgroundColor:'#fff',paddingTop:'2%',paddingBottom:'3%'}}>
                                        <Link to={{pathname:'/'+arr[1]+'/home/follow',state:this.props.location.state,state4:this.props.location.state4}} style={{color:this.state.selectFollow.color,borderBottom:this.state.selectFollow.borderBottom,fontSize:'16px',marginLeft:'10px'}}>关注</Link>
                                    ...
                                    <div style={{width:'100%',whiteSpace:"pre-wrap"}}>
                                        <div style={{width:'94%',marginTop:'3%',marginLeft:'3%',marginRight:'3%',backgroundColor:'#fff',float:'left',paddingBottom:'2%',height:'250px'}}>
                                            ...
                                            <div style={{float:'left',width:'100%',color:'#000',float:'left',marginTop:'3%'}}>
                                                <Link to={{pathname:'/'+arr[1]+'/'+data.aid+'/'+data.uid+'/home/fopeople',state:this.props.location.state,state4:data.uid}}><img src={'http://116.62.14.0:8402/images/'+data.uimage} style={{width:'55px',height:'55px',marginLeft:'2%',marginRight:'3%',borderRadius:'50%',float:'left'}} /></Link>
                                            ...
                                            <div style={{float:'left',width:'90%',marginLeft:'5%',marginRight:'5%'}}>
                                                <Link to={{pathname:'/'+arr[1]+'/home/article/'+data.aid+'/'+data.uid,state1:data.aid,state:this.props.location.state,state2:data.uid}}>
                                ...
                                <Link to={{pathname:'/'+arr[1]+'/home/write',state:this.props.location.state}}>
                        ...
                        onPress={() => {
                            ...
                            this.props.history.push({pathname:'/'+arr[1]+'/mine',state:this.props.location.state,state1:this.props.location.state1,state2:this.props.location.state2})
                        }}
                        >
                            {/* <Mine/> */}
                        </TabBar.Item>
