...
export default class Praise extends Component {
    ...
    componentDidMount(){
        ...
        fetch('http://116.62.14.0:8402/message/zan/'+arr[1])
        .then((res)=>res.json())
        .then((res)=>{
    ...
    render() {
        ...
        return (
            <div>
                <NavBar
                    icon={<Link to={{pathname:'/'+arr[1]+'/home/news',state:this.props.location.state}}><Icon type="left" style={{color:'#000'}}/></Link>}
