    ...
    render() {
        ...
        return (
            <div style={{backgroundColor:'red',height:'300px'}}>
                <div>
                    <NavLink to={{pathname:`${path}`,search:'',mtab2:this.props.location.mtab2}}>最热</NavLink>
                    
                    <NavLink to={{pathname:`${path}`,search:'?id=new',mtab2:this.props.location.mtab2}}>最新</NavLink>
                    <div>
