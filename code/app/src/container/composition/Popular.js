                ...
                {this.state.data.map(data=>(
                    data.mtab==='sucai'?
                        ...
                        <div style={{backgroundColor:'#fff',marginBottom:'4%',padding:'2%',height:'200px'}}>
                            <Link to={{pathname:'/composition/label/s/sdetails/'+data.mid,mtab2:data.mid,state:this.props.location.state}} style={{color:'#000',fontSize:'120%'}}>
                                <div style={{width:'100%',float:'left',fontSize:'90%',padding:'2%'}}>素材--{data.msname}</div>
                                <div style={{width:'100%',float:'left',height:'80%',float:'left',fontWeight:'500',textAlign:'left',paddingTop:'10%',fontSize:'120%',paddingLeft:'2%',paddingBottom:'2%'}}>{data.mtitle}</div>
                            </Link>
                        </div> : 
                        ...
                        <div style={{marginBottom:'4%',paddingBottom:'2%',height:'300px',backgroundColor:'#fff'}}>
                            <Link to={{pathname:'/composition/label/s/sdetails/'+data.mid,mtab2:data.mid,state:this.props.location.state}} style={{color:'#000',fontSize:'110%'}}>
                                ...
                                <div style={{width:'100%',height:'25%',float:'left',fontWeight:'600',fontSize:'120%',paddingTop:'8%',paddingLeft:'2%',paddingRight:'2%'}}>
