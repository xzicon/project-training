                ...
                {this.state.data.map(data=>(
                    data.mtab==='sucai'?
                        ...
                        <div style={{backgroundColor:'#fff',marginBottom:'4%',padding:'2%',height:'200px'}}>
                            <Link to={{pathname:'/'+arr[1]+'/'+data.msid+'/composition/label/s/sdetails/'+data.mid,mtab2:data.mid,state:this.props.location.state,mtab:data.mtab}} style={{color:'#000',fontSize:'120%'}}>
                        ...
                        <div style={{marginBottom:'4%',paddingBottom:'2%',height:'270px',backgroundColor:'#fff'}}>
                            <Link to={{pathname:'/'+arr[1]+'/'+data.msid+'/composition/label/s/sdetails/'+data.mid,mtab2:data.mid,state:this.props.location.state,mtab:data.mtab}} style={{color:'#000',fontSize:'110%'}}>
                                <video src={`http://116.62.14.0:8402/images/`+data.mimage} id="myPlayer" poster='' controls playsInline webkit-playsinline style={{width:'100%'}}></video>
